...
class VideoContentSetup {
	...
	onContentLoad(e) {
		...
		const videoid = extractID(content.data.videoSrc);

		content.element = document.createElement('lite-youtube');
		content.element.setAttribute('videoid', videoid);
		content.element.style.maxWidth = 'none';
